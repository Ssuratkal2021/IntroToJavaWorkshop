...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		//1. Use this online tool to make a maze image and drop it into your day5 package: 
		maze = ImageIO.read(getClass().getResource("Maze.jpg"));
		
		//2. set the mouse pointer to the start of your maze using:
		new Robot().mouseMove(0, 75);
...
if(mouseColor==-1632832){
	JOptionPane.showMessageDialog(null, "You won!!!" );
		...
		//7. find a scary sound and put it in the day5 package where you put your maze picture. You can find a sound on freesound.org. Log in ascc.
...
showScaryImage("scaryphoto.jpeg");
	}
